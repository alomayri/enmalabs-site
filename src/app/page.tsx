...
import { hero, manifesto, apps, chapters, closingCta, balsamStory } from "@/lib/content";
...
export default function Home() {
  return (
    <>
      ...
      {/* SCENE 3 — WHAT WE'RE BUILDING (Balsam, first) */}
      <section id="apps" className="border-t border-rule bg-mist-soft/40">
        <div className="mx-auto max-w-7xl px-6 py-32 md:py-40">
          <div className="mb-20 max-w-4xl">
            <Reveal>
              <p className="font-mono text-xs uppercase tracking-[0.4em] text-whisper">
                What we&rsquo;re building first
              </p>
            </Reveal>
            <Reveal delay={0.08}>
              <h2 className="mt-6 font-display text-5xl leading-[1.05] tracking-tight md:text-7xl">
                One app, made with <span className="italic text-ember">care</span>.
              </h2>
            </Reveal>
            <Reveal delay={0.16}>
              <p className="mt-6 max-w-2xl text-lg text-whisper md:text-xl">
                We are starting with the one we needed most. More will follow, slowly, only when they are worth your time.
              </p>
            </Reveal>
          </div>
          <div>
      ...
      {/* SCENE 3.5 — NARRATED STORY (a scene from Balsam) */}
